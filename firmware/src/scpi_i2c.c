...
/**
 * @brief  function to configure the parameters of the user I2C based on the data set on the I2C
 * structure
 *
 */
void scpi_i2c_enable()
{
    ...
    // pull-ups are already active on slave side, this is just a fail-safe in case the wiring is
    // faulty

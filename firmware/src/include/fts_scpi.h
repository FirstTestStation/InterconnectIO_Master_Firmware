 ...
 *
 *
 * @copyright Copyright (c) 2021 Valentin Milea <valentin.milea@gmail.com> SPDX-License-Identifier:
 * MIT Copyright (c) 2024, D.Lockhead. All rights reserved.
 *
...
//!< Error
#define ARB_ODD_ERR 1 //!< Error on  Arbitrary block for word definition

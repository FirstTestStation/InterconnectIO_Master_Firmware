...
void test_command(void)
{
    ...
    test_cmd_out("Test 10.0 SCPI EEprom command", "CFG:Read:EEPROM:STR?  check\n", "#", &c_test, &buffer);
    TEST_SCPI_INPUT("CFG:Write:Eeprom:STR TEST ,TCMD\n");
    test_cmd_out("Test 10.1 SCPI EEprom command", "CFG:Read:EEPROM:STR? TEST\n", "TCMD", &c_test, &buffer);
    TEST_SCPI_INPUT("CFG:Write:Eeprom:STR TEST ,TEST\n");
    test_cmd_out("Test 10.2 SCPI EEprom command", "CFG:Read:EEPROM:STR?  test\n", "TEST", &c_test, &buffer);

...
Include dependency graph for scpi\+\_\+uart.\+h\+:\nopagebreak
\begin{figure}[H]
\begin{center}
\leavevmode
\includegraphics[width=196pt]{scpi__uart_8h__incl}
\end{center}
\end{figure}
...
\#define {\bfseries USER\+\_\+\+RX\+\_\+\+PIN}~13
...
\#define {\bfseries USER\+\_\+\+CTS\+\_\+\+PIN}~14
...
\#define {\bfseries USER\+\_\+\+RTS\+\_\+\+PIN}~15
...
\#define {\bfseries USER\+\_\+\+UART}~uart0
...
\#define {\bfseries DEF\+\_\+\+USER\+\_\+\+PARITY}~UART\+\_\+\+PARITY\+\_\+\+NONE
...
\#define {\bfseries DEF\+\_\+\+USER\+\_\+\+BITS}~8
...
\#define {\bfseries DEF\+\_\+\+USER\+\_\+\+STOP}~1
...
\#define {\bfseries DEF\+\_\+\+USER\+\_\+\+HANDSHAKE}~0
...
\#define {\bfseries DEF\+\_\+\+USER\+\_\+\+STATUS}~0
...
\#define {\bfseries DEF\+\_\+\+TIMEOUT\+\_\+\+MS}~1000
\begin{DoxyCompactList}\small\item\em Default timeout duration in milliseconds. \end{DoxyCompactList}\item 
\mbox{\Hypertarget{scpi__uart_8h_a8946ff8fb16989090bfa173b39f71e7f}\label{scpi__uart_8h_a8946ff8fb16989090bfa173b39f71e7f}} 
\#define {\bfseries DEF\+\_\+\+EOL}~1
\begin{DoxyCompactList}\small\item\em Default character added at the end of string (1= \textquotesingle{}~\newline
...
\#define {\bfseries DEF\+\_\+\+LASTCHAR}~\textquotesingle{}\textbackslash{}n\textquotesingle{}
...
\#define {\bfseries UART\+\_\+\+PROT\+\_\+\+LETTER\+\_\+\+NOVALID}~32
...
\#define {\bfseries UART\+\_\+\+PROT\+\_\+\+MISSING}~33
...
\#define {\bfseries UART\+\_\+\+RX\+\_\+\+TIMEOUT\+\_\+\+MS}~34
...
\#define {\bfseries UART\+\_\+\+LASTCHAR\+\_\+\+TIMEOUT\+\_\+\+MS}~35
...
\#define {\bfseries UART\+\_\+\+BUFFER\+\_\+\+FULL}~36
...
\#define {\bfseries UART\+\_\+\+NOT\+\_\+\+ENABLED}~37
...
void {\bfseries scpi\+\_\+uart\+\_\+enable} (void)
...
void {\bfseries scpi\+\_\+uart\+\_\+disable} (void)
...
\mbox{\Hypertarget{scpi__uart_8h_a3c15892e785168ea65b012576235528b}\label{scpi__uart_8h_a3c15892e785168ea65b012576235528b}} 
void {\bfseries add\+\_\+eol} (void)
\begin{DoxyCompactList}\small\item\em Function to add the defined EOL character at the end of write string. \end{DoxyCompactList}\item 
...
void \mbox{\hyperlink{scpi__uart_8h_a3c69ee3674bd2259a4f1035a0d9ceeac}{scpi\+\_\+uart\+\_\+set\+\_\+eol}} (uint8\+\_\+t val)
\begin{DoxyCompactList}\small\item\em Function to set the EOL on the structure, EOL will be added at the end of string to send. \end{DoxyCompactList}\item 
uint8\+\_\+t \mbox{\hyperlink{scpi__uart_8h_a4202a867295a94338d06c5d26d7e7ec5}{scpi\+\_\+uart\+\_\+get\+\_\+eol}} (void)
\begin{DoxyCompactList}\small\item\em Function to get the EOL on the structure. \end{DoxyCompactList}\item 
...
const char $\ast$ \mbox{\hyperlink{scpi__uart_8h_ae76db62a14ef10d4921e2739b5221ee5}{scpi\+\_\+uart\+\_\+get\+\_\+protocol}} (void)
...
\end{DoxyReturn}
\mbox{\Hypertarget{scpi__uart_8h_a4202a867295a94338d06c5d26d7e7ec5}\label{scpi__uart_8h_a4202a867295a94338d06c5d26d7e7ec5}} 
\index{scpi\_uart.h@{scpi\_uart.h}!scpi\_uart\_get\_eol@{scpi\_uart\_get\_eol}}
\index{scpi\_uart\_get\_eol@{scpi\_uart\_get\_eol}!scpi\_uart.h@{scpi\_uart.h}}
\doxysubsubsection{\texorpdfstring{scpi\_uart\_get\_eol()}{scpi\_uart\_get\_eol()}}
{\footnotesize\ttfamily uint8\+\_\+t scpi\+\_\+uart\+\_\+get\+\_\+eol (\begin{DoxyParamCaption}\item[{void}]{ }\end{DoxyParamCaption})}



Function to get the EOL on the structure. 

\begin{DoxyReturn}{Returns}
uint32\+\_\+t actual eol value 
\end{DoxyReturn}
...
\end{DoxyReturn}
\mbox{\Hypertarget{scpi__uart_8h_ae76db62a14ef10d4921e2739b5221ee5}\label{scpi__uart_8h_ae76db62a14ef10d4921e2739b5221ee5}} 
...
\end{DoxyReturn}
\texorpdfstring{$<$}{<} return protocol string\mbox{\Hypertarget{scpi__uart_8h_a4940674ea5d55c2b968af3e4eee8dca3}\label{scpi__uart_8h_a4940674ea5d55c2b968af3e4eee8dca3}} 
...
\hline
\end{DoxyParams}
\mbox{\Hypertarget{scpi__uart_8h_a3c69ee3674bd2259a4f1035a0d9ceeac}\label{scpi__uart_8h_a3c69ee3674bd2259a4f1035a0d9ceeac}} 
\index{scpi\_uart.h@{scpi\_uart.h}!scpi\_uart\_set\_eol@{scpi\_uart\_set\_eol}}
\index{scpi\_uart\_set\_eol@{scpi\_uart\_set\_eol}!scpi\_uart.h@{scpi\_uart.h}}
\doxysubsubsection{\texorpdfstring{scpi\_uart\_set\_eol()}{scpi\_uart\_set\_eol()}}
{\footnotesize\ttfamily void scpi\+\_\+uart\+\_\+set\+\_\+eol (\begin{DoxyParamCaption}\item[{uint8\+\_\+t}]{val }\end{DoxyParamCaption})}



Function to set the EOL on the structure, EOL will be added at the end of string to send. 


\begin{DoxyParams}{Parameters}
{\em val} & EOL (End-\/\+Of-\/\+Line) to save on structure \\
\hline
\end{DoxyParams}
...
\texorpdfstring{$<$}{<} return error number\mbox{\Hypertarget{scpi__uart_8h_a8c6e0b0b9a1aaa0c264b072b38aa70fc}\label{scpi__uart_8h_a8c6e0b0b9a1aaa0c264b072b38aa70fc}} 

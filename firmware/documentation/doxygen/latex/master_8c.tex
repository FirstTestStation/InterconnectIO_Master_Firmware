...
\#define {\bfseries MESSAGE\+\_\+\+SIZE}~92
...
\#define {\bfseries QUEUE\+\_\+\+SIZE}~12
...
int \mbox{\hyperlink{master_8c_aea68381afe044625867caa3e9d3d5836}{init\+\_\+main\+\_\+com}} ()
...
struct \{\\
\>\mbox{\hyperlink{structMESSAGE}{MESSAGE}} {\bfseries messages} \mbox{[}\mbox{\hyperlink{master_8c_a142810068f1b99cd93d3fc9f0e160e02}{QUEUE\_SIZE}}\mbox{]}\\
\>\>{\em Array of messages stored in the queue. }\\
\>char {\bfseries size} \mbox{[}\mbox{\hyperlink{master_8c_a142810068f1b99cd93d3fc9f0e160e02}{QUEUE\_SIZE}}\mbox{]}\\
\>\>{\em Array containing sizes of each message in the queue. }\\
\>int {\bfseries begin}\\
\>\>{\em Index of the first message in the queue. }\\
\>int {\bfseries end}\\
\>\>{\em Index where the next message will be added. }\\
\>int {\bfseries current\_load}\\
...
\begin{center}
\leavevmode
\includegraphics[width=302pt]{master_8c_a5f6549f2d2461465f770c1b277910225_icgraph}
\end{center}
\end{figure}
\mbox{\Hypertarget{master_8c_aea68381afe044625867caa3e9d3d5836}\label{master_8c_aea68381afe044625867caa3e9d3d5836}} 
\index{master.c@{master.c}!init\_main\_com@{init\_main\_com}}
\index{init\_main\_com@{init\_main\_com}!master.c@{master.c}}
\doxysubsubsection{\texorpdfstring{init\_main\_com()}{init\_main\_com()}}
{\footnotesize\ttfamily int init\+\_\+main\+\_\+com (\begin{DoxyParamCaption}{ }\end{DoxyParamCaption})}



Initialisation of the main communication uart (serial port) the SCPI command are received by the serial port. Baud rate is read from the Configuration EEPROM In case of error, default baud rate will be use. 
...
\begin{center}
\leavevmode
\includegraphics[width=297pt]{master_8c_aea68381afe044625867caa3e9d3d5836_cgraph}
\end{center}
\end{figure}
Here is the caller graph for this function\+:\nopagebreak
\begin{figure}[H]
\begin{center}
\leavevmode
\includegraphics[width=246pt]{master_8c_aea68381afe044625867caa3e9d3d5836_icgraph}
\end{center}
\end{figure}
...
Never pass by hereHere is the call graph for this function\+:\nopagebreak
\begin{figure}[H]
\begin{center}
\leavevmode
\includegraphics[width=350pt]{master_8c_a840291bc02cba5474a4cb46a9b9566fe_cgraph}
\end{center}
\end{figure}
...
This variable manages a circular queue that holds messages and tracks their sizes. It uses indices to mark the beginning and end of the queue, and keeps track of the current number of messages (load). 
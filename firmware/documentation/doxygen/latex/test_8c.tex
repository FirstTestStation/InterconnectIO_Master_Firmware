...
\begin{DoxyCompactList}\small\item\em Function to add\+\_\+message to circular buffer. \end{DoxyCompactList}\item 
...
void \mbox{\hyperlink{test_8c_a78b67679ee11d44f8ca2ad1a9ab58d53}{internal\+\_\+test\+\_\+sequence}} (char $\ast$testboard\+\_\+num, uint8\+\_\+t run)
\begin{DoxyCompactList}\small\item\em Main routine to perform internal test using selftest board. The routine has been used to validate hardware and software during development if run=0, the menu will be displayed to operator to select which internal test to run. IF run \texorpdfstring{$>$}{>} 0, the internal test will run directly. \end{DoxyCompactList}\item 
const char $\ast$ \mbox{\hyperlink{test_8c_a33510a8b3333bfec3368b10acddafd28}{internal\+\_\+test\+\_\+sequence\+\_\+result}} (void)
\begin{DoxyCompactList}\small\item\em 
\begin{DoxyItemize}
\item Return contains of the last test 
\end{DoxyItemize}\end{DoxyCompactList}\item 
uint8\+\_\+t \mbox{\hyperlink{test_8c_ac70b7d6422a8c2b63fd63ed04ed046e6}{test\+\_\+selftest}} (char $\ast$testboard\+\_\+num, uint8\+\_\+t run)
\begin{DoxyCompactList}\small\item\em 
\begin{DoxyItemize}
...
void {\bfseries test\+\_\+i2c\+\_\+adx} ()
...
\begin{DoxyCompactItemize}
\item 
char \mbox{\hyperlink{test_8c_a9bd6c8fb710bc1dc1d1ae9e4b724da85}{out\+\_\+buffer}} \mbox{[}MAX\+\_\+\+OUT\+\_\+\+BUFFER\mbox{]}
...
\begin{center}
\leavevmode
\includegraphics[width=350pt]{test_8c_ada61a5d73ba9477f5805e729284f4e17_cgraph}
\end{center}
\end{figure}
...
Function to add\+\_\+message to circular buffer. 


\begin{DoxyParams}{Parameters}
{\em buffer} & Pointer to structure that contains messages \\
\hline
{\em message} & Pointer to message to save in the structure \\
\hline
\end{DoxyParams}
...
\texorpdfstring{$<$}{<} Initialize Start index of the buffer

\texorpdfstring{$<$}{<} Initialize End index of the buffer

\texorpdfstring{$<$}{<} Initialize Flag indicating if the buffer is fullHere is the caller graph for this function\+:\nopagebreak
\begin{figure}[H]
\begin{center}
\leavevmode
\includegraphics[width=350pt]{test_8c_a964f12386d49fd5a0df6add2daf20508_icgraph}
\end{center}
\end{figure}
\mbox{\Hypertarget{test_8c_a78b67679ee11d44f8ca2ad1a9ab58d53}\label{test_8c_a78b67679ee11d44f8ca2ad1a9ab58d53}} 
...
{\footnotesize\ttfamily void internal\+\_\+test\+\_\+sequence (\begin{DoxyParamCaption}\item[{char $\ast$}]{testboard\+\_\+num,  }\item[{uint8\+\_\+t}]{run }\end{DoxyParamCaption})}



Main routine to perform internal test using selftest board. The routine has been used to validate hardware and software during development if run=0, the menu will be displayed to operator to select which internal test to run. IF run \texorpdfstring{$>$}{>} 0, the internal test will run directly. 
...
\hline
\end{DoxyParams}
Open Power Relay to remove power on Selftest boardHere is the call graph for this function\+:\nopagebreak
\begin{figure}[H]
\begin{center}
\leavevmode
\includegraphics[width=350pt]{test_8c_a78b67679ee11d44f8ca2ad1a9ab58d53_cgraph}
\end{center}
\end{figure}
\mbox{\Hypertarget{test_8c_a33510a8b3333bfec3368b10acddafd28}\label{test_8c_a33510a8b3333bfec3368b10acddafd28}} 
\index{test.c@{test.c}!internal\_test\_sequence\_result@{internal\_test\_sequence\_result}}
\index{internal\_test\_sequence\_result@{internal\_test\_sequence\_result}!test.c@{test.c}}
\doxysubsubsection{\texorpdfstring{internal\_test\_sequence\_result()}{internal\_test\_sequence\_result()}}
{\footnotesize\ttfamily const char $\ast$ internal\+\_\+test\+\_\+sequence\+\_\+result (\begin{DoxyParamCaption}\item[{void}]{ }\end{DoxyParamCaption})}
...
\begin{DoxyReturn}{Returns}
return pointer to result str 
\end{DoxyReturn}
\mbox{\Hypertarget{test_8c_a47a0e9953fea609fecae7ddc8fbc33a3}\label{test_8c_a47a0e9953fea609fecae7ddc8fbc33a3}} 
...
\begin{center}
\leavevmode
\includegraphics[width=300pt]{test_8c_a47a0e9953fea609fecae7ddc8fbc33a3_cgraph}
\end{center}
\end{figure}
...
\begin{center}
\leavevmode
\includegraphics[width=318pt]{test_8c_afced784f998c7b95f4563f9ff40d5fc8_cgraph}
\end{center}
\end{figure}
...
\begin{center}
\leavevmode
\includegraphics[width=350pt]{test_8c_ade29dc0be6bd27144ab8ac944fad90de_icgraph}
\end{center}
\end{figure}
...
\begin{center}
\leavevmode
\includegraphics[width=350pt]{test_8c_a0c6f39b967bd2a9a74fd40a40cf54687_icgraph}
\end{center}
\end{figure}
...
\begin{center}
\leavevmode
\includegraphics[width=350pt]{test_8c_a2c187f3a1a5e046de0872ebd623e8d56_cgraph}
\end{center}
\end{figure}
...
\end{DoxyReturn}
Send command to SCPI engine

refresh watchdogHere is the caller graph for this function\+:\nopagebreak
\begin{figure}[H]
\begin{center}
\leavevmode
\includegraphics[width=350pt]{test_8c_af9513558e25e8efc4248c5f6c4dcd18e_icgraph}
\end{center}
\end{figure}
\mbox{\Hypertarget{test_8c_a3a741d0c84f19f8a596e9db8a3055383}\label{test_8c_a3a741d0c84f19f8a596e9db8a3055383}} 
...
Send command to SCPI engineHere is the caller graph for this function\+:\nopagebreak
\begin{figure}[H]
\begin{center}
\leavevmode
\includegraphics[width=350pt]{test_8c_a3a741d0c84f19f8a596e9db8a3055383_icgraph}
\end{center}
\end{figure}
\mbox{\Hypertarget{test_8c_a032a8eab3b1447960ec13ee39358c450}\label{test_8c_a032a8eab3b1447960ec13ee39358c450}} 
...
\begin{center}
\leavevmode
\includegraphics[width=350pt]{test_8c_a032a8eab3b1447960ec13ee39358c450_icgraph}
\end{center}
\end{figure}
\mbox{\Hypertarget{test_8c_ad171446f146deeb8c2c79986e0f843c7}\label{test_8c_ad171446f146deeb8c2c79986e0f843c7}} 
...
PRINT FINAL REPORT AFTER TEST COMPLETIONHere is the call graph for this function\+:\nopagebreak
\begin{figure}[H]
\begin{center}
\leavevmode
\includegraphics[width=300pt]{test_8c_ad171446f146deeb8c2c79986e0f843c7_cgraph}
\end{center}
\end{figure}
Here is the caller graph for this function\+:\nopagebreak
\begin{figure}[H]
\begin{center}
\leavevmode
\includegraphics[width=335pt]{test_8c_ad171446f146deeb8c2c79986e0f843c7_icgraph}
\end{center}
\end{figure}
\mbox{\Hypertarget{test_8c_a7fd0a3e557c0c44cce4de05c0f581406}\label{test_8c_a7fd0a3e557c0c44cce4de05c0f581406}} 
...
\begin{center}
\leavevmode
\includegraphics[width=279pt]{test_8c_a7fd0a3e557c0c44cce4de05c0f581406_cgraph}
\end{center}
\end{figure}
...
\begin{center}
\leavevmode
\includegraphics[width=321pt]{test_8c_a74346a55978a0cec00fea16b92e3cd35_cgraph}
\end{center}
\end{figure}
...
Wait to let time to relay to close and power the selftest boardHere is the call graph for this function\+:\nopagebreak
\begin{figure}[H]
\begin{center}
\leavevmode
\includegraphics[width=306pt]{test_8c_a7c4492986b11310638a7730bf6658532_cgraph}
\end{center}
\end{figure}
Here is the caller graph for this function\+:\nopagebreak
\begin{figure}[H]
\begin{center}
\leavevmode
\includegraphics[width=347pt]{test_8c_a7c4492986b11310638a7730bf6658532_icgraph}
\end{center}
\end{figure}
\mbox{\Hypertarget{test_8c_a0acd1ee00e871f30689aab1a7246feb0}\label{test_8c_a0acd1ee00e871f30689aab1a7246feb0}} 
...
Normally run step by step with debugger and hardware verified by visual check or by measuring voltage Here is the call graph for this function\+:\nopagebreak
\begin{figure}[H]
\begin{center}
\leavevmode
\includegraphics[width=350pt]{test_8c_a0acd1ee00e871f30689aab1a7246feb0_cgraph}
\end{center}
\end{figure}
\mbox{\Hypertarget{test_8c_ac70b7d6422a8c2b63fd63ed04ed046e6}\label{test_8c_ac70b7d6422a8c2b63fd63ed04ed046e6}} 
...
{\footnotesize\ttfamily uint8\+\_\+t test\+\_\+selftest (\begin{DoxyParamCaption}\item[{char $\ast$}]{testboard\+\_\+num,  }\item[{uint8\+\_\+t}]{run }\end{DoxyParamCaption})}
...
\end{DoxyReturn}
\texorpdfstring{$<$}{<} Variable used by TEST\+\_\+\+SCPI\+\_\+\+INPUT

\texorpdfstring{$<$}{<} array who will contains parts of SCPI command
...
\begin{center}
\leavevmode
\includegraphics[width=305pt]{test_8c_ac70b7d6422a8c2b63fd63ed04ed046e6_cgraph}
\end{center}
\end{figure}
Here is the caller graph for this function\+:\nopagebreak
\begin{figure}[H]
\begin{center}
\leavevmode
\includegraphics[width=323pt]{test_8c_ac70b7d6422a8c2b63fd63ed04ed046e6_icgraph}
\end{center}
\end{figure}
\mbox{\Hypertarget{test_8c_ae9ec3dc653dc7431f107092091e4dafc}\label{test_8c_ae9ec3dc653dc7431f107092091e4dafc}} 
...
\mbox{\Hypertarget{test_8c_a9bd6c8fb710bc1dc1d1ae9e4b724da85}\label{test_8c_a9bd6c8fb710bc1dc1d1ae9e4b724da85}} 
...
{\footnotesize\ttfamily char out\+\_\+buffer\mbox{[}MAX\+\_\+\+OUT\+\_\+\+BUFFER\mbox{]}}



Output buffer for storing data to be sent. 

This buffer holds the data that will be sent via the output channel (e.\+g., serial or communication port). It has a fixed size of MAX\+\_\+\+OUT\+\_\+\+BUFFER. \mbox{\Hypertarget{test_8c_a668cec89f06b89ddf4d1ee33527eba18}\label{test_8c_a668cec89f06b89ddf4d1ee33527eba18}} 
